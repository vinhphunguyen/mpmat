...
if (genPolyMesh )
  NElem = 800;
  [Node,Element,Supp,Load,P]=PolyMesher(@TwoCirclesDomain,NElem,40);
...
fnode   = fopen('twoDisks-interface-solid.nodes');
felem   = fopen('twoDisks-interface-solid.elems');
