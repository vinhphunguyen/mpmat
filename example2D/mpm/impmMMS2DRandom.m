...
%
% Similar to impmMMS2D but with random material points.
%
% Vinh Phu Nguyen
...
N      = elemCount*4; %// number of points
points = rand(N,2);

pCount  = size(points,1);
%volume  = res.volume;
%volume0 = res.volume;
mass    = (lx*ly)*rho/N*ones(pCount,1);
coords  = points;
coords0 = coords;
...
while ( t < time )
  ...
  for p=1:pCount
    ...
    uex1     = mmsU1(XX(1),t);
    uex2     = mmsU2(XX(2),t);
    dispNorm = dispNorm + ((up(1)-uex1)^2 + (up(2)-uex2)^2);
  end
...
% G=0.0001
disp1=[5.307906243795050e-04;
       2.839526536037930e-04;
       1.272044667801758e-04;
