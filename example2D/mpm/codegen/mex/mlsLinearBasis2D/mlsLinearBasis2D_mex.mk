START_DIR = /Users/vinhphunguyen/my-codes/MAMP/example2D/mpm

MATLAB_ROOT = /Applications/MATLAB_R2015a.app
MAKEFILE = mlsLinearBasis2D_mex.mk

include mlsLinearBasis2D_mex.mki


SRC_FILES =  \
	mlsLinearBasis2D_data.c \
	...
	mlsLinearBasis2D_emxutil.c \
	_coder_mlsLinearBasis2D_info.c

MEX_FILE_NAME_WO_EXT = mlsLinearBasis2D_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mlsLinearBasis2D"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/mlsLinearBasis2D/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mlsLinearBasis2D/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mlsLinearBasis2D/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/mlsLinearBasis2D/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
