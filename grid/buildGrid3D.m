...
mesh.nodeCount = size(mesh.node,1);
mesh.deltax    = Lx/igaMesh.noElemsU;
mesh.deltay    = Ly/igaMesh.noElemsV;
mesh.deltaz    = Lz/igaMesh.noElemsW;
mesh.numx      = igaMesh.noElemsU;
mesh.numy      = igaMesh.noElemsV;
mesh.numz      = igaMesh.noElemsW;
